...
public class AnandRestaurant implements Restaurant {

    Integer restaurantId;
    String restaurantName;
    double restaurantLatitude;
    double restaurantLongitude;
    Status deliveryAgentStatus = Status.AVAILABLE;
    Integer timeTaken;

    public AnandRestaurant(Integer restaurantId, String restaurantName, Integer restaurantLatitude, Integer restaurantLongitude, Integer timeTaken) {
